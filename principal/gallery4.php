					...
					<div class="col-xs-10 col-xs-offset-1 couple-container">
						...
						<div id="mansonry" class="row gallery-wrapper">
							...
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/43.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/43.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/44.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/44.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item <-->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/45.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/45.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							...
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/46.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/46.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/47.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/47.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/48.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/48.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/49.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/49.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
