					...
					<div class="col-xs-10 col-xs-offset-1 couple-container">
						...
						<div id="mansonry" class="row gallery-wrapper">
							...
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/31.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/31.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/32.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/32.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item <-->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/33.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/33.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							...
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/34.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/34.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/35.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/35.jpg" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/36.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/36.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/37.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/37.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/38.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/38.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/39.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/39.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/40.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/40.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/41.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/41.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
							<!-- item -->
							<div class="mansonry-item col-sm-3">
								<a href="img/couple-pictures/42.jpg" data-lightbox-gallery="gallery1">
									<img src="img/couple-pictures-thumb/42.png" alt="">
									<div class="mask"></div>
								</a>
							</div>
							<!-- /item -->	
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="section-pagination">
									<div class="row">
										<div class="col-xs-4">
											<a href="gallery2.php">&lt;&lt; Anterior</a>
										</div>
