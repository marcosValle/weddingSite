			...
			<div class="page-content page-home">
				...
				<div class="row">
					<div class="home-logo col-sm-8 col-sm-offset-2">
						<p class="couple-title">Deborah & Marcos</p>
					</div>
				</div>
				<!-- /home-logo -->
				<!-- Countdown container -->
				<div class="row">
					<div class="countdown-container">
						...
						<!-- /icon -->
						<!-- countdown title top -->
						<h2 class="countdown-title countdown-title1"><span class="countdown-title-borders">16 de Julho, 2016 no Rio de Janeiro, RJ</span></h2>
						<!-- /countdown title top -->
						...
						<!-- /countdown -->
						<!-- countdown title bot -->
						<h3 class="countdown-title countdown-title2"><span class="countdown-title-borders">Até o casamento!</span></h3>
						<!-- countdown title /bot -->
					</div>
				</div>
				<!-- /Countdown Container -->
